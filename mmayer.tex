...
\begin{document}
\name{Umeshwaran.M}
\tagline{Programmer Analyst }
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%\photo{3.3cm}{profile.jpg}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{mumeshwaran@gmail.com}
   \phone{+91 89396 93880}
%  \mailaddress{Address, Street, 00000 County}
  \location{Chennai, India}
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
  %\linkedin{linkedin.com/in/ronak-dedhiya}
   \github{github.com/Umeshwaran} % I'm just making this up though.
...
\cvevent{Programmer Analyst(3 years)}{Cognizant Technology Solutions}{Chennai,India}
\divider
\smallskip

\cvinternal{MFRP - Training (September 2016- January 2017)}
...
\smallskip
\cvinternal{NY MMIS - Xerox Corporation (January 2017- August 2017)}
...
\cvinternal{IES - Xerox Corporation (September 2017- July 2018)}
...
\smallskip
\cvinternal{Truprovider (August 2018- Present)}
...
\cvevent{Senior Software Developer(Nov 2019 - Till now)}{Ducont Systems}{Chennai,India}
%\divider


\cvinternal{Notisify (Nov 2019 - Till now)}
...
\cvskill{Java,Servlets}{8}
%\divider
\cvskill{HTML,CSS,JS}{6}
\cvskill{Android}{6}
\cvskill{Angular js}{5}
